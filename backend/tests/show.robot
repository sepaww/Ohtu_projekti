...
User can see added entries
    ...
    Table Row Should Contain    entrylist    1    Marshall Bruce Mathers III Jonne Book of rhymes 2 70 22 Delete
    Table Row Should Contain    entrylist    2    Marshall Bruce Mathers III Jonne Book of rhymes 3 71 23 Delete
